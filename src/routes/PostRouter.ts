...
PostRouter.put('/groups/:postId/remove', postController.removePostFromGroup); // Удаление поста из группы
PostRouter.put('/posts/:postId', postController.updateStatus); // Изменить статус записи
